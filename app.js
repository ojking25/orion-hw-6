...
function addToCart() {
    ...
    const fruit = document.getElementById("add-item").value;
...
function checkout() { 
    ...
    if (cart.apple === 0 && cart.banana === 0 && cart.coconut === 0) {
        errorText.innerText = "You must have something in your cart if you wanna checkout!";
        return;
    }

    errorText.innerText = "";

    let transactionCopy = { ...cart };  
...
function resetCart() {
    ...
    document.getElementById("amn-error-text").innerText = "";
    document.getElementById("checkout-error-text").innerText = "";
